...
// ADDED: Buy License URL controlled from Render Environment Variables
const BUY_LICENSE_URL = process.env.BUY_LICENSE_URL || "";
...
// ADDED: Firefox Buy License button reads this URL from Render
app.get("/api/config",(_,res)=>res.json({
  ok:true,
  buy_license_url:BUY_LICENSE_URL
}));
